...
export default function ManualKepOperatorPage() {
  ...
  const [data, setData] = useState<ManualKepOperatorData[]>([]);
  ...
  useEffect(() => {
    document.title = "ESTR | Manual Kepatuhan Operator";
  ...
  const handleApprove = () => {
    console.log("Approving data:", selectedData);
    // Here you would typically make an API call to approve the data
  ...
  const handleReject = () => {
    ...
    // Here you would typically make an API call to reject the data
