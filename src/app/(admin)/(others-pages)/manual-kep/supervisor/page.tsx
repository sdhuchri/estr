...
import ManualKepSupervisorClient from "./ManualKepSupervisorClient";
...
async function ManualKepSupervisorData() {
  ...
  let data: ManualKepSupervisorData[] = [];
  ...
  return <ManualKepSupervisorClient initialData={data} />;
}
...
export const metadata = {
  title: "STR | Manual Kepatuhan Supervisor",
  description: "Kelola data laporan manual kepatuhan supervisor"
};