...
export default function ListRejectTidakAktifPage() {
  const router = useRouter();
  const [isLoading, setIsLoading] = useState(true);
  const [data, setData] = useState<ListRejectData[]>([]);
  ...
  useEffect(() => {
    document.title = "ESTR | List Reject Tidak Aktif";
  ...
  // Define table columns based on the image (same as aktif page)
  const columns = [
    {
      key: "NO",
      label: "No",
