...
export default function ListRejectAktifPage() {
  ...
  useEffect(() => {
    document.title = "ESTR | List Reject Aktif";
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="p-6">
        ...
        <DataTable
          ...
          title="List Reject Aktif"
          description="Kelola data laporan yang direject dan masih aktif"
        />
      </div>
